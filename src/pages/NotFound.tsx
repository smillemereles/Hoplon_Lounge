    ...
    <div className="min-h-screen bg-hoplon-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 px-8 max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link to="/">
            <Button className="bg-gradient-to-r from-hoplon-gold to-hoplon-gold-dark text-hoplon-black hover:from-hoplon-gold-dark hover:to-hoplon-gold transition-all duration-300 font-semibold px-8 py-3 text-base">
              <Home size={20} />
              Volver al Inicio
            </Button>
          </Link>
          ...
          >
            <a
              href="mailto:contacto@hoplon.com"
